                    ...
                    >
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-base font-semibold text-gray-900">{day.day}</span>
                        </div>
                        {day.isOpen ? (
                    ...
                    {dayPrices.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {dayPrices.map((dp, index) => (
                          <div key={index} className="space-y-3 rounded-lg border border-amber-200 bg-white p-4">
                    ...
                    {timePrices.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {timePrices.map((tp, index) => (
                          <div key={index} className="space-y-3 rounded-lg border border-indigo-200 bg-white p-4">
