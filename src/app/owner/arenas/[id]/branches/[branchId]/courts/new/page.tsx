...
export default function NewCourtPage() {
    ...
    try {
      const payload = {
        ...
        dayPrices: dayPrices
          ...
          .map((dp) => ({ day: dp.day, price: Number.parseFloat(dp.price) })),
        timePrices: timePrices
          ...
          .map((tp) => ({
            ...
            days:
              tp.dayGroup === 'weekdays'
                ? ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']
                : tp.dayGroup === 'weekends'
                ? ['Saturday', 'Sunday']
                : [],
          })),
      };
  ...
  return (
    <>
      <ScreenLoader
        show={loading}
        headline="Adding your court..."
        subtext="Generating pricing & slot schedules"
      />
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex items-center justify-between rounded-2xl bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-700 px-5 py-4 text-emerald-50 shadow-lg">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-semibold text-white">Add New Court</h1>
            <p className="mt-1 text-xs text-emerald-100">
              Configure sport, timings and pricing for this court.
            </p>
          </div>
          <Link
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Choose the sport played on this court
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, courtNotes: e.target.value })
                  }
                  rows={3}
                  className="w-full rounded-lg border-2 border-gray-200 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 transition-colors focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Optional: set different prices for specific days or times.
                    </p>
                  </div>
                </div>
                <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-xl border border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50 p-6">
                    <div className="mb-4 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Weekend or special-day pricing.
                        </p>
                      </div>
                      <button
                        type="button"
                    ...
                    {dayPrices.length === 0 ? (
                      <p className="text-sm italic text-gray-600">
                        No day-specific prices set. Base price will be used for all
                        days.
                      </p>
                    ) : (
                  ...
                  <div className="rounded-xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-blue-50 p-6">
                    <div className="mb-4 flex items-center justify-between">
                      <div>
                        <h3 className="mb-1 text-lg font-bold text-gray-900">
                          Time-specific pricing (priority)
                        </h3>
                        <p className="text-sm text-gray-600">
                          Peak hour or off-peak pricing. Time slabs override day and
                          base prices.
                        </p>
                      </div>
                      <button
                    ...
                    {timePrices.length === 0 ? (
                      <p className="text-sm italic text-gray-600">
                        No time-specific prices set. Same price will apply for all
                        hours.
                      </p>
                    ) : (
                      <div className="space-y-3">
