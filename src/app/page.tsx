  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-50 to-lime-100">
      ...
      <div className="text-center mb-10 sm:mb-12">
        ...
        <p className="text-lg sm:text-xl text-emerald-700 mb-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
          {/* Owner Card */}
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-all border border-emerald-100">
